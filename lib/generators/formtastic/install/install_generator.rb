...
module Formtastic
  ...
  class InstallGenerator < Rails::Generators::Base
    desc "Copies formtastic.css and formtastic_changes.css to public/stylesheets/, formtastic.js to public/javascripts/, and a config initializer to config/initializers/formtastic_config.rb"
    ...
    def copy_files
      ...
      template        'formtastic.js',          'public/javascripts/formtastic.js'
    end
  end
end
