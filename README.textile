...
In the meantime, there's nothing stopping you from mixing some old fashioned HTML and ERB for custom widgets in with the Formtastic DSL stuff in your views, or subclassing JustinFrench::Formtastic::SemanticFormBuilder and re-implement (or add to) the builder.  I'd love to hear what others are finding a need for.
...
* completing the spec/test suite is a top priority
...
Subclassing JustinFrench::Formtastic::SemanticFormBuilder yourself or forking the project is an option too!
