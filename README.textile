...
h4. For Rails 3 (or Rails 2 with Bundler)
...
Optionally, run @rails generate formtastic:install@ to copy some stylesheets and a configuration initializer into your application.
...
<pre>
  config.gem 'formtastic', '~> 1.1.0'
</pre>

Optionally, run @./script/generate formtastic@ to copy some stylesheets and a configuration initializer into your application.
