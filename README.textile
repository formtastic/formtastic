...
* Run the input generator and provide your custom input name. For example, @rails generate formtastic:input hat_size@. This creates the file @app/inputs/hat_size_input.rb@
