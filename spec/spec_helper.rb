...
module FormtasticSpecHelper
  ...
  def mock_everything
    ...
    @fred.stub!(:errors).and_return(mock('errors', :[] => nil, :any? => false))
    ...
    @bob.stub!(:errors).and_return(mock('errors', :[] => nil, :any? => false))
    ...
    @james.stub!(:errors).and_return(mock('errors', :[] => nil, :any? => false))
    ...
    @new_post.stub!(:errors).and_return(mock('errors', :[] => nil, :any? => false))
    ...
    @freds_post.stub!(:errors).and_return(mock('errors', :[] => nil, :any? => false))
    ...
    @new_mm_post.stub!(:errors).and_return(mock('errors', :[] => nil, :any? => false))
